...
describe('Tracking', () => {
    ...
    it('Should extra options zipcodes', () => {
        const zipcodes = mockItemZipcodes();
        const { getByTestId } = makeSut(zipcodes);

        const button = getByTestId("onPressExtraOptions");

        fireEvent.click(button);

        const date = getByTestId("dateExtraOptions").textContent;
        const route = getByTestId("routeExtraOptions").textContent;
